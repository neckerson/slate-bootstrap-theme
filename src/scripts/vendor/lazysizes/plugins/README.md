...
NOTE: This has been modified from the main repo to allow additional ``background-image`` values. For more information, check out [issue #585](https://github.com/aFarkas/lazysizes/issues/585)
